...
const when = document.getElementById("when") as HTMLFormInputElement;
const where = document.getElementById("where") as HTMLFormInputElement;
const who = document.getElementById("who") as HTMLFormInputElement;
...
for (const button of document.getElementsByClassName("btnSave")) {
  button.addEventListener("click", async () => {
    ...
    formData.set("item", params.has("item") ? (params.get("item") as string) : "-1");
